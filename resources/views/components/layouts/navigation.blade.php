<nav class="bg-white shadow-sm" x-data="{ open: false }">
    ...
    <div class="sm:hidden" x-show="open" @click.away="open = false">
        <div class="pt-2 pb-3">
            ...
            <a href="#"
                class="mt-1 block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">Destinations</a>
        </div>
